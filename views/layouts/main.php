...
//                console.log($(ui.draggable).hasClass("cloned"));
                if (!$(ui.draggable).hasClass("cloned")) {
                    ...
                    $(newDraggable).css('height', 300 + "px");
                    $(newDraggable).css('width', 300 + "px");
                    $('.fa', newDraggable).css('font-size', 300 + "px");
                    $(newDraggable).css('left', 800 / 2 - 300 / 2 + "px");
                    $(newDraggable).css('top', 800 / 2 - 300 / 2 + "px");
                    $(this).append(newDraggable);
                    $(newDraggable).mouseout(function () {
                        $(this).find('.icon-close').css({
                            'display': 'none'
                        });
                        $(this).find('.colorpicker').css({
                            'display': 'none'
                        });
        ...
        $(document).on('input', '.colorpicker', function () {
            $(this).parent().find('.fa').css('color', $(this).val());
        });

        $(document).on('input', '.bg-colorpicker', function () {
//            console.log($(this).val());
            $('#droppable').css('background', $(this).val());
...
//        });
        ...
        $(".tojpg").click(function () {
            if(isBGTransparent){
               $("#droppable").css('background', 'transparent');
            }
            html2canvas($("#droppable"), {
                onrendered: function (canvas) {
                    console.log(canvas);
...
//                $("body").append(canvas);
        ...
        $('.addNewText').click(function () {
            ...
            var handle = $(".custom-handle", newTextClone);
            $(".slider", newTextClone).slider({
                create: function () {
                    handle.text($(this).slider("value"));
                },
                slide: function (event, ui) {
                    handle.text(ui.value);
                    $("#" + newId).css('font-size', ui.value);
                }
            });
        ...
        $(document).on('resize', '.text', function () {
        ...
        $(document).on('keyup', '.edittext', function () {
            var myId = $(this).parent().attr('myid');
            $("#" + myId).html($(this).val());
            $("#" + myId).resizable('destroy').resizable({
                aspectRatio: 8 / 1
            });
        });
...
//            console.log($(this).attr('src'));
            $("#droppable").css('background', 'url(' + $(this).attr("src") + ') no-repeat center center fixed');
            $("#droppable").css('-webkit-background-size', 'cover');
            $("#droppable").css('-moz-background-size', 'cover');
            $("#droppable").css('-o-background-size', 'cover');
            $("#droppable").css(' background-size', 'cover');
            isBGTransparent = false;
        });

        $('.transparentbg').click(function () {
            $("#droppable").css('background', 'url(img/grid.png)');
...
<!--    $(document).ready(function () {-->
<!--        var result = '';-->
<!--       $("#font-group li").each(function () {-->
<!--           var fontName = $('.icon-name', $(this)).html();-->
<!--           result = result + '<div class="draggable"><div class="icon">' +-->
<!--               '<i class="fa '+ fontName +' fa-lg"></i>' +-->
<!--               '</div><div class="icon-close">X</div><input type="color" class="colorpicker"></div>'-->
<!--       })-->
